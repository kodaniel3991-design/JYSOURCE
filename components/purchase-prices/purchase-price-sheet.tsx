  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="flex h-full w-full max-w-4xl flex-col p-0 sm:max-w-4xl">
        <div className="flex items-center justify-between border-b pl-5 pr-5 py-3">
        ...
        <div ref={formRef} className="flex flex-col flex-1 min-h-0 px-5 pt-4 pb-0 text-xs">
          <Tabs defaultValue="price" className="flex flex-col flex-1 min-h-0 min-w-0">
            <TabsList className="w-full justify-start h-9 rounded-lg bg-muted/60 p-1 min-w-0">
              <TabsTrigger value="price" className="text-xs px-4">단가 정보</TabsTrigger>
              <TabsTrigger value="extra" className="text-xs px-4">기타 정보</TabsTrigger>
            </TabsList>

            <div className="flex-1 overflow-y-auto min-h-0 mt-3 px-1 pb-4">
              {/* ── 단가 정보: 품목 정보 + 구매처·단가 + 수정 정보 ── */}
              <TabsContent value="price" className="mt-0 space-y-6">
                {/* 품목 정보 */}
                <div>
                  <p className="text-[11px] font-semibold text-muted-foreground uppercase tracking-wide mb-3">품목 정보</p>
                  <div className="grid gap-x-6 gap-y-4 sm:grid-cols-2">
                    <div className="min-h-[3.25rem] flex flex-col justify-end gap-1">
                      ...
                      <Input
                        ...
                        onChange={(e) => setDraft((p) => ({ ...p, itemCode: e.target.value }))}
                        className="h-8 text-xs"
                        placeholder="직접 입력 또는 검색으로 선택"
                        readOnly={mode === "edit"}
                      />
                    </div>
                    <div className="min-h-[3.25rem] flex flex-col justify-end gap-1">
                ...
                {/* 구매처·단가 */}
                <div>
                  <p className="text-[11px] font-semibold text-muted-foreground uppercase tracking-wide mb-3">구매처 단가</p>
                  <div className="grid gap-x-6 gap-y-4 sm:grid-cols-2">
                    <div className="min-h-[3.25rem] flex flex-col justify-end gap-1">
                      <div className="flex items-center gap-2">
                ...
                {mode === "edit" && (
                  <>
                    <div className="border-t" />
                    <div>
                      <p className="text-[11px] font-semibold text-muted-foreground uppercase tracking-wide mb-3">수정 정보</p>
                      <div className="min-h-[3.25rem] flex flex-col justify-end gap-1">
              ...
              <TabsContent value="extra" className="mt-0 space-y-6">
                {/* 재고·발주 */}
                <div>
                  <p className="text-[11px] font-semibold text-muted-foreground uppercase tracking-wide mb-3">재고·발주</p>
                  <div className="grid gap-x-6 gap-y-4 sm:grid-cols-2">
                    <div className="min-h-[3.25rem] flex flex-col justify-end gap-1">
                ...
                {/* 외주·기타 */}
                <div>
                  <p className="text-[11px] font-semibold text-muted-foreground uppercase tracking-wide mb-3">외주·기타</p>
                  <div className="grid gap-x-6 gap-y-4 sm:grid-cols-2">
                    <div className="min-h-[3.25rem] flex flex-col justify-end">
                      <div className="flex items-center gap-2">
