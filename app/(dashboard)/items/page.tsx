      ...
      <ItemRegisterSheet
        ...
        onSave={async (state) => {
          ...
          const payload = {
            ...
            // Technical
            unit: state.basicInfo.stockUnit || "EA",
            salesUnitCode: state.basicInfo.salesUnit || "EA",
          ...
          editingItem
            ? {
                ...
                basicInfo: {
                  ...
                  stockUnit: editingItem.unit ?? "EA",
                  salesUnit: editingItem.salesUnitCode ?? "EA",
                ...
                technical: {
                  ...defaultItemRegisterState.technical,
                  salesUnit: editingItem.unit ?? editingItem.salesUnitCode ?? "EA",
                  salesUnitConversion: editingItem.unitConversion ?? "1",
                  weightKg: editingItem.itemWeight != null ? String(editingItem.itemWeight) : "",
                  drawingSize: editingItem.drawingSize ?? "",
                  packQty: editingItem.packQty != null ? String(editingItem.packQty) : "",
                  customerSpec: editingItem.customerWarehouse ?? "",
                  hNo: editingItem.hNoDiameter != null ? String(editingItem.hNoDiameter) : "",
                  lNo: editingItem.lNoSpecificGravity != null ? String(editingItem.lNoSpecificGravity) : "",
                  deliveryContainer: editingItem.deliveryContainer ?? "",
                },
                procurement: {
                  ...defaultItemRegisterState.procurement,
                  supplierItemNo: editingItem.supplierItemNo ?? "",
                  purchaseManager: editingItem.buyerCode ?? "",
                  salesManager: editingItem.salesRepCode ?? "",
                  requirementManager: editingItem.requirementRepCode ?? "",
                  salesUnitPrice: editingItem.salesUnitPrice != null ? String(editingItem.salesUnitPrice) : "",
                  orderPolicy: editingItem.materialOrderPolicyCode ?? "",
                  lastReceiptUnitPrice: editingItem.lastReceiptUnitPrice != null ? String(editingItem.lastReceiptUnitPrice) : "",
                  standardCost: editingItem.standardCost != null ? String(editingItem.standardCost) : "",
                  internalPrice: editingItem.internalUnitPrice != null ? String(editingItem.internalUnitPrice) : "",
                },
              }
            : undefined
        }
