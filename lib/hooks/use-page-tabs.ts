...
const ROUTE_LABELS: { pattern: RegExp | string; label: string }[] = [
  ...
  { pattern: "/accounting/purchase-vouchers",              label: "매입전표 일괄생성" },
  { pattern: "/accounting/vouchers",                       label: "회계전표관리" },
  { pattern: "/accounting/voucher-approval",               label: "전표승인/해제관리" },
  { pattern: "/accounting/voucher-print",                  label: "전표조회 및 출력" },
  { pattern: "/accounting/journal",                        label: "분개장" },
  { pattern: "/accounting/ledger",                         label: "매입매출장" },
